...
const e = require('express');
  ...
  app.get('/', (req, res) => {
    res.send('¡Bienvenido al servidor de autenticación con JWT!');
  });
...
function refreshAccessToken(refreshToken) {
  ...
  .then(data => {
    ...
    // Ahora, realiza la solicitud a la sección de usuarios protegida
    solicitudSeccionUsuarios(newAccessToken, data.message);
  })
  .catch(error => {
